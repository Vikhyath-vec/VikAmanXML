...
class KGAT(object):
    ...
    def eval(self, sess, feed_dict):
        ...
        # print(f'embedding of user 0: {self.get_user_embedding(0)}')
    ...
    #         val = tf.nn.embedding_lookup(self.ua_embeddings, user_id).numpy()
    #     return val
    
    # def get_item_embedding(self, item_id):
    #     with tf.device('/CPU:0'):
    #         val = tf.nn.embedding_lookup(self.ea_embeddings, item_id).numpy()
    #     return val
