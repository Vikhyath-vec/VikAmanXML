...
from module_new import ContinuousPromptLearning
from utils import rouge_score, bleu_score, DataLoader, Batchify, now_time, ids2tokens, unique_sentence_percent, \
    feature_detect, feature_matching_ratio, feature_coverage_ratio, feature_diversity, DataLoaderKGAT
...
corpus = DataLoaderKGAT(args.data_path, args.index_dir, tokenizer, args.words)
...
nuser = len(corpus.user_org_id_remap_id.keys())
nitem = len(corpus.item_org_id_remap_id.keys())
